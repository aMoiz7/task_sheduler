...
const SignUp = () => {
  ...
  return (
    <div className=' flex justify-center align-middle mt-20'><div className="  flex-col  px-6 py-20  border rounded-2xl  bg-blue-100  border-gray-600  w-1/3  h-5/2 flex justify-center ">
    ...
    <div className="mt-10 sm:mx-auto sm:w-full sm:max-w-sm ">
      ...
      <div>
          ...
          <div className="mt-2">
            <input id="username" name="username" type="text" onChange={handler} required className="block w-full rounded-md border-0 py-1.5 text-gray-900 shadow-sm ring-1 ring-inset ring-gray-300 placeholder:text-gray-400 focus:ring-2 focus:ring-inset focus:ring-indigo-600 sm:text-sm sm:leading-6" />
          </div>
        </div>
        <div>
